...
/**
 * "grip-corner" icon — tree-shakable per-icon component.
...
const GripCornerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GripCornerBase.displayName = "GripCorner";

export const GripCorner = memo(GripCornerBase) as typeof GripCornerBase;
GripCorner.displayName = "GripCorner";
