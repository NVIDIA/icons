...
/**
 * "camera-linked" icon — tree-shakable per-icon component.
...
const CameraLinkedBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CameraLinkedBase.displayName = "CameraLinked";

export const CameraLinked = memo(CameraLinkedBase) as typeof CameraLinkedBase;
CameraLinked.displayName = "CameraLinked";
