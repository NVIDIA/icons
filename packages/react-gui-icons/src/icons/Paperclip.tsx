...
/**
 * "paperclip" icon — tree-shakable per-icon component.
...
const PaperclipBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PaperclipBase.displayName = "Paperclip";

export const Paperclip = memo(PaperclipBase) as typeof PaperclipBase;
