...
/**
 * "swatches" icon — tree-shakable per-icon component.
...
const SwatchesBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SwatchesBase.displayName = "Swatches";

export const Swatches = memo(SwatchesBase) as typeof SwatchesBase;
