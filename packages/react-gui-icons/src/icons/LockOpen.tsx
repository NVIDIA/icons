...
/**
 * "lock-open" icon — tree-shakable per-icon component.
...
const LockOpenBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LockOpenBase.displayName = "LockOpen";

export const LockOpen = memo(LockOpenBase) as typeof LockOpenBase;
