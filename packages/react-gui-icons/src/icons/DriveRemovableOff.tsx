...
/**
 * "drive-removable-off" icon — tree-shakable per-icon component.
...
const DriveRemovableOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "drive-removable-off",
...
DriveRemovableOffBase.displayName = "DriveRemovableOff";

export const DriveRemovableOff = memo(
  DriveRemovableOffBase,
) as typeof DriveRemovableOffBase;
DriveRemovableOff.displayName = "DriveRemovableOff";
