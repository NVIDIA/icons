...
/**
 * "castle" icon — tree-shakable per-icon component.
...
const CastleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CastleBase.displayName = "Castle";

export const Castle = memo(CastleBase) as typeof CastleBase;
