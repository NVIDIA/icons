...
/**
 * "bug-off" icon — tree-shakable per-icon component.
...
const BugOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BugOffBase.displayName = "BugOff";

export const BugOff = memo(BugOffBase) as typeof BugOffBase;
