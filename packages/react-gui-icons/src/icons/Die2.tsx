...
/**
 * "die-2" icon — tree-shakable per-icon component.
...
const Die2Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Die2Base.displayName = "Die2";

export const Die2 = memo(Die2Base) as typeof Die2Base;
Die2.displayName = "Die2";
