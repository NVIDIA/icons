...
/**
 * "family" icon — tree-shakable per-icon component.
...
const FamilyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FamilyBase.displayName = "Family";

export const Family = memo(FamilyBase) as typeof FamilyBase;
