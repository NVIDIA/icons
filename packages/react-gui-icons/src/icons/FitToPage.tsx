...
/**
 * "fit-to-page" icon — tree-shakable per-icon component.
...
const FitToPageBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FitToPageBase.displayName = "FitToPage";

export const FitToPage = memo(FitToPageBase) as typeof FitToPageBase;
FitToPage.displayName = "FitToPage";
