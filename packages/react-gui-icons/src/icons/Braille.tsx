...
/**
 * "braille" icon — tree-shakable per-icon component.
...
const BrailleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BrailleBase.displayName = "Braille";

export const Braille = memo(BrailleBase) as typeof BrailleBase;
