...
/**
 * "plugin" icon — tree-shakable per-icon component.
...
const PluginBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PluginBase.displayName = "Plugin";

export const Plugin = memo(PluginBase) as typeof PluginBase;
