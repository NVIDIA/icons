...
/**
 * "transfer-horizontal" icon — tree-shakable per-icon component.
...
const TransferHorizontalBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "transfer-horizontal",
...
TransferHorizontalBase.displayName = "TransferHorizontal";

export const TransferHorizontal = memo(
  TransferHorizontalBase,
) as typeof TransferHorizontalBase;
