...
/**
 * "refresh" icon — tree-shakable per-icon component.
...
const RefreshBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RefreshBase.displayName = "Refresh";

export const Refresh = memo(RefreshBase) as typeof RefreshBase;
