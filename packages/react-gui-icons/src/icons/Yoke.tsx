...
/**
 * "yoke" icon — tree-shakable per-icon component.
...
const YokeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
YokeBase.displayName = "Yoke";

export const Yoke = memo(YokeBase) as typeof YokeBase;
Yoke.displayName = "Yoke";
