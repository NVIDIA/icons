...
/**
 * "battery-0-off" icon — tree-shakable per-icon component.
...
const Battery0OffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Battery0OffBase.displayName = "Battery0Off";

export const Battery0Off = memo(Battery0OffBase) as typeof Battery0OffBase;
Battery0Off.displayName = "Battery0Off";
