...
/**
 * "reset" icon — tree-shakable per-icon component.
...
const ResetBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ResetBase.displayName = "Reset";

export const Reset = memo(ResetBase) as typeof ResetBase;
