...
/**
 * "collection" icon — tree-shakable per-icon component.
...
const CollectionBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CollectionBase.displayName = "Collection";

export const Collection = memo(CollectionBase) as typeof CollectionBase;
