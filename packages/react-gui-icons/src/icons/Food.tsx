...
/**
 * "food" icon — tree-shakable per-icon component.
...
const FoodBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FoodBase.displayName = "Food";

export const Food = memo(FoodBase) as typeof FoodBase;
