...
/**
 * "arrow-left" icon — tree-shakable per-icon component.
...
const ArrowLeftBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
ArrowLeftBase.displayName = "ArrowLeft";

export const ArrowLeft = memo(ArrowLeftBase) as typeof ArrowLeftBase;
