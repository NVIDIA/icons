...
/**
 * "gallery-strip" icon — tree-shakable per-icon component.
...
const GalleryStripBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GalleryStripBase.displayName = "GalleryStrip";

export const GalleryStrip = memo(GalleryStripBase) as typeof GalleryStripBase;
