...
/**
 * "beaker" icon — tree-shakable per-icon component.
...
const BeakerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BeakerBase.displayName = "Beaker";

export const Beaker = memo(BeakerBase) as typeof BeakerBase;
