...
/**
 * "thermometer" icon — tree-shakable per-icon component.
...
const ThermometerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ThermometerBase.displayName = "Thermometer";

export const Thermometer = memo(ThermometerBase) as typeof ThermometerBase;
