...
/**
 * "projector" icon — tree-shakable per-icon component.
...
const ProjectorBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ProjectorBase.displayName = "Projector";

export const Projector = memo(ProjectorBase) as typeof ProjectorBase;
