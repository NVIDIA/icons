...
/**
 * "phone-laptop" icon — tree-shakable per-icon component.
...
const PhoneLaptopBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PhoneLaptopBase.displayName = "PhoneLaptop";

export const PhoneLaptop = memo(PhoneLaptopBase) as typeof PhoneLaptopBase;
