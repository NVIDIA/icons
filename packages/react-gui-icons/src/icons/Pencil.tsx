...
/**
 * "pencil" icon — tree-shakable per-icon component.
...
const PencilBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PencilBase.displayName = "Pencil";

export const Pencil = memo(PencilBase) as typeof PencilBase;
