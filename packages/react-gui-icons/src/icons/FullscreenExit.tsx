...
/**
 * "fullscreen-exit" icon — tree-shakable per-icon component.
...
const FullscreenExitBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "fullscreen-exit",
...
FullscreenExitBase.displayName = "FullscreenExit";

export const FullscreenExit = memo(
  FullscreenExitBase,
) as typeof FullscreenExitBase;
