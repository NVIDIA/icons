...
/**
 * "ram" icon — tree-shakable per-icon component.
...
const RamBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RamBase.displayName = "Ram";

export const Ram = memo(RamBase) as typeof RamBase;
Ram.displayName = "Ram";
