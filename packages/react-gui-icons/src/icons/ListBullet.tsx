...
/**
 * "list-bullet" icon — tree-shakable per-icon component.
...
const ListBulletBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ListBulletBase.displayName = "ListBullet";

export const ListBullet = memo(ListBulletBase) as typeof ListBulletBase;
