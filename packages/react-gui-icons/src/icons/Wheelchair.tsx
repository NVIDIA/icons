...
/**
 * "wheelchair" icon — tree-shakable per-icon component.
...
const WheelchairBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WheelchairBase.displayName = "Wheelchair";

export const Wheelchair = memo(WheelchairBase) as typeof WheelchairBase;
