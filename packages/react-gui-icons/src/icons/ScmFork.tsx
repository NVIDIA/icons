...
/**
 * "scm-fork" icon — tree-shakable per-icon component.
...
const ScmForkBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScmForkBase.displayName = "ScmFork";

export const ScmFork = memo(ScmForkBase) as typeof ScmForkBase;
ScmFork.displayName = "ScmFork";
