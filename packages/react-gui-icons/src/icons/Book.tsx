...
/**
 * "book" icon — tree-shakable per-icon component.
...
const BookBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BookBase.displayName = "Book";

export const Book = memo(BookBase) as typeof BookBase;
