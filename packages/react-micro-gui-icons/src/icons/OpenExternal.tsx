...
/**
 * "open-external" icon — tree-shakable per-icon component.
...
const OpenExternalBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
OpenExternalBase.displayName = "OpenExternal";

export const OpenExternal = memo(OpenExternalBase) as typeof OpenExternalBase;
