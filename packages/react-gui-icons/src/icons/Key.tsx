...
/**
 * "key" icon — tree-shakable per-icon component.
...
const KeyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
KeyBase.displayName = "Key";

export const Key = memo(KeyBase) as typeof KeyBase;
Key.displayName = "Key";
