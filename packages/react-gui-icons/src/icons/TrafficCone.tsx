...
/**
 * "traffic-cone" icon — tree-shakable per-icon component.
...
const TrafficConeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
TrafficConeBase.displayName = "TrafficCone";

export const TrafficCone = memo(TrafficConeBase) as typeof TrafficConeBase;
