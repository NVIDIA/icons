...
/**
 * "die-4" icon — tree-shakable per-icon component.
...
const Die4Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Die4Base.displayName = "Die4";

export const Die4 = memo(Die4Base) as typeof Die4Base;
Die4.displayName = "Die4";
