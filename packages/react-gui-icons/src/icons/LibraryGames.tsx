...
/**
 * "library-games" icon — tree-shakable per-icon component.
...
const LibraryGamesBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LibraryGamesBase.displayName = "LibraryGames";

export const LibraryGames = memo(LibraryGamesBase) as typeof LibraryGamesBase;
LibraryGames.displayName = "LibraryGames";
