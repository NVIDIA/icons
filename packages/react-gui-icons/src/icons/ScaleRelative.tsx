...
/**
 * "scale-relative" icon — tree-shakable per-icon component.
...
const ScaleRelativeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScaleRelativeBase.displayName = "ScaleRelative";

export const ScaleRelative = memo(
  ScaleRelativeBase,
) as typeof ScaleRelativeBase;
ScaleRelative.displayName = "ScaleRelative";
