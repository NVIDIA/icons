...
/**
 * "magnet" icon — tree-shakable per-icon component.
...
const MagnetBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MagnetBase.displayName = "Magnet";

export const Magnet = memo(MagnetBase) as typeof MagnetBase;
