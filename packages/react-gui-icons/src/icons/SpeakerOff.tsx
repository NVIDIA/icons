...
/**
 * "speaker-off" icon — tree-shakable per-icon component.
...
const SpeakerOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SpeakerOffBase.displayName = "SpeakerOff";

export const SpeakerOff = memo(SpeakerOffBase) as typeof SpeakerOffBase;
