...
/**
 * "eye" icon — tree-shakable per-icon component.
...
const EyeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EyeBase.displayName = "Eye";

export const Eye = memo(EyeBase) as typeof EyeBase;
Eye.displayName = "Eye";
