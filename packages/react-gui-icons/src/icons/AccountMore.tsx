...
/**
 * "account-more" icon — tree-shakable per-icon component.
...
const AccountMoreBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AccountMoreBase.displayName = "AccountMore";

export const AccountMore = memo(AccountMoreBase) as typeof AccountMoreBase;
AccountMore.displayName = "AccountMore";
