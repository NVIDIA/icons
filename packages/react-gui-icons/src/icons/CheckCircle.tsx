...
/**
 * "check-circle" icon — tree-shakable per-icon component.
...
const CheckCircleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CheckCircleBase.displayName = "CheckCircle";

export const CheckCircle = memo(CheckCircleBase) as typeof CheckCircleBase;
