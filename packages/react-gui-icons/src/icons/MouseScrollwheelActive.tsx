...
/**
 * "mouse-scrollwheel-active" icon — tree-shakable per-icon component.
...
const MouseScrollwheelActiveBase = forwardRef<
  SVGSVGElement,
  NvidiaGuiIconProps
>(({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
  ...
  return createElement(
    "svg",
    {
      ...
      "data-icon-name": "mouse-scrollwheel-active",
...
MouseScrollwheelActiveBase.displayName = "MouseScrollwheelActive";

export const MouseScrollwheelActive = memo(
  MouseScrollwheelActiveBase,
) as typeof MouseScrollwheelActiveBase;
MouseScrollwheelActive.displayName = "MouseScrollwheelActive";
