...
/**
 * "display" icon — tree-shakable per-icon component.
...
const DisplayBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DisplayBase.displayName = "Display";

export const Display = memo(DisplayBase) as typeof DisplayBase;
