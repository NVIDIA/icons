...
/**
 * "map" icon — tree-shakable per-icon component.
...
const IconMapBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IconMapBase.displayName = "IconMap";

export const IconMap = memo(IconMapBase) as typeof IconMapBase;
