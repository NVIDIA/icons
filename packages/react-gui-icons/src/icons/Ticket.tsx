...
/**
 * "ticket" icon — tree-shakable per-icon component.
...
const TicketBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
TicketBase.displayName = "Ticket";

export const Ticket = memo(TicketBase) as typeof TicketBase;
