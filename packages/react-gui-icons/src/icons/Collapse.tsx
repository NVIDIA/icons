...
/**
 * "collapse" icon — tree-shakable per-icon component.
...
const CollapseBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Collapse = memo(CollapseBase) as typeof CollapseBase;
