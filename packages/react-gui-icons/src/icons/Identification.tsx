...
/**
 * "identification" icon — tree-shakable per-icon component.
...
const IdentificationBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IdentificationBase.displayName = "Identification";

export const Identification = memo(
  IdentificationBase,
) as typeof IdentificationBase;
