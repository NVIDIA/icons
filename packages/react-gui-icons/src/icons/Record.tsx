...
/**
 * "record" icon — tree-shakable per-icon component.
...
const RecordBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RecordBase.displayName = "Record";

export const Record = memo(RecordBase) as typeof RecordBase;
