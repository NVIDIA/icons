...
/**
 * "workstation-off" icon — tree-shakable per-icon component.
...
const WorkstationOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "workstation-off",
...
WorkstationOffBase.displayName = "WorkstationOff";

export const WorkstationOff = memo(
  WorkstationOffBase,
) as typeof WorkstationOffBase;
WorkstationOff.displayName = "WorkstationOff";
