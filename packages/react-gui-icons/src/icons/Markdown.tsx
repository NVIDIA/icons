...
/**
 * "markdown" icon — tree-shakable per-icon component.
...
const MarkdownBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Markdown = memo(MarkdownBase) as typeof MarkdownBase;
