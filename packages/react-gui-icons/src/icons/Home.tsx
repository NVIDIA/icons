...
/**
 * "home" icon — tree-shakable per-icon component.
...
const HomeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Home = memo(HomeBase) as typeof HomeBase;
