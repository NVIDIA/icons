...
/**
 * "export" icon — tree-shakable per-icon component.
...
const ExportBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ExportBase.displayName = "Export";

export const Export = memo(ExportBase) as typeof ExportBase;
