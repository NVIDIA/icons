...
/**
 * "die-5" icon — tree-shakable per-icon component.
...
const Die5Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Die5Base.displayName = "Die5";

export const Die5 = memo(Die5Base) as typeof Die5Base;
Die5.displayName = "Die5";
