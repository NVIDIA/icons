...
/**
 * "profile" icon — tree-shakable per-icon component.
...
const ProfileBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Profile = memo(ProfileBase) as typeof ProfileBase;
