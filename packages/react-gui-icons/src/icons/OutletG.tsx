...
/**
 * "outlet-g" icon — tree-shakable per-icon component.
...
const OutletGBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletGBase.displayName = "OutletG";

export const OutletG = memo(OutletGBase) as typeof OutletGBase;
OutletG.displayName = "OutletG";
