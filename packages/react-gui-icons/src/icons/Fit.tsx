...
/**
 * "fit" icon — tree-shakable per-icon component.
...
const FitBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FitBase.displayName = "Fit";

export const Fit = memo(FitBase) as typeof FitBase;
Fit.displayName = "Fit";
