...
/**
 * "profile-off" icon — tree-shakable per-icon component.
...
const ProfileOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ProfileOffBase.displayName = "ProfileOff";

export const ProfileOff = memo(ProfileOffBase) as typeof ProfileOffBase;
ProfileOff.displayName = "ProfileOff";
