...
/**
 * "award-trophy" icon — tree-shakable per-icon component.
...
const AwardTrophyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AwardTrophyBase.displayName = "AwardTrophy";

export const AwardTrophy = memo(AwardTrophyBase) as typeof AwardTrophyBase;
AwardTrophy.displayName = "AwardTrophy";
