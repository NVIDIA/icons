...
/**
 * "package" icon — tree-shakable per-icon component.
...
const PackageBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PackageBase.displayName = "Package";

export const Package = memo(PackageBase) as typeof PackageBase;
