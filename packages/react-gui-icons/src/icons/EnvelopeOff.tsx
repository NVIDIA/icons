...
/**
 * "envelope-off" icon — tree-shakable per-icon component.
...
const EnvelopeOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EnvelopeOffBase.displayName = "EnvelopeOff";

export const EnvelopeOff = memo(EnvelopeOffBase) as typeof EnvelopeOffBase;
EnvelopeOff.displayName = "EnvelopeOff";
