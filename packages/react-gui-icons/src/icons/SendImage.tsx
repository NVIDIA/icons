...
/**
 * "send-image" icon — tree-shakable per-icon component.
...
const SendImageBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SendImageBase.displayName = "SendImage";

export const SendImage = memo(SendImageBase) as typeof SendImageBase;
SendImage.displayName = "SendImage";
