...
/**
 * "clap-board" icon — tree-shakable per-icon component.
...
const ClapBoardBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ClapBoardBase.displayName = "ClapBoard";

export const ClapBoard = memo(ClapBoardBase) as typeof ClapBoardBase;
ClapBoard.displayName = "ClapBoard";
