...
/**
 * "hit" icon — tree-shakable per-icon component.
...
const HitBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HitBase.displayName = "Hit";

export const Hit = memo(HitBase) as typeof HitBase;
Hit.displayName = "Hit";
