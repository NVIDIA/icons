...
/**
 * "document-preview" icon — tree-shakable per-icon component.
...
const DocumentPreviewBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "document-preview",
...
DocumentPreviewBase.displayName = "DocumentPreview";

export const DocumentPreview = memo(
  DocumentPreviewBase,
) as typeof DocumentPreviewBase;
