...
/**
 * "cube" icon — tree-shakable per-icon component.
...
const CubeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CubeBase.displayName = "Cube";

export const Cube = memo(CubeBase) as typeof CubeBase;
