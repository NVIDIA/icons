...
/**
 * "camera" icon — tree-shakable per-icon component.
...
const CameraBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CameraBase.displayName = "Camera";

export const Camera = memo(CameraBase) as typeof CameraBase;
