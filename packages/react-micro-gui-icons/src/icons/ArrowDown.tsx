...
/**
 * "arrow-down" icon — tree-shakable per-icon component.
...
const ArrowDownBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
ArrowDownBase.displayName = "ArrowDown";

export const ArrowDown = memo(ArrowDownBase) as typeof ArrowDownBase;
