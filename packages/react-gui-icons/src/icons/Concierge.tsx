...
/**
 * "concierge" icon — tree-shakable per-icon component.
...
const ConciergeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ConciergeBase.displayName = "Concierge";

export const Concierge = memo(ConciergeBase) as typeof ConciergeBase;
