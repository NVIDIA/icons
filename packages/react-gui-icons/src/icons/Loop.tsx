...
/**
 * "loop" icon — tree-shakable per-icon component.
...
const LoopBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LoopBase.displayName = "Loop";

export const Loop = memo(LoopBase) as typeof LoopBase;
