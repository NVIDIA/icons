...
/**
 * "battery-charging" icon — tree-shakable per-icon component.
...
const BatteryChargingBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BatteryChargingBase.displayName = "BatteryCharging";

export const BatteryCharging = memo(
  BatteryChargingBase,
) as typeof BatteryChargingBase;
