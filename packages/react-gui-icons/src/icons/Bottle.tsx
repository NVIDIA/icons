...
/**
 * "bottle" icon — tree-shakable per-icon component.
...
const BottleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BottleBase.displayName = "Bottle";

export const Bottle = memo(BottleBase) as typeof BottleBase;
