...
/**
 * "firewall" icon — tree-shakable per-icon component.
...
const FirewallBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FirewallBase.displayName = "Firewall";

export const Firewall = memo(FirewallBase) as typeof FirewallBase;
