...
/**
 * "feeling-very-happy" icon — tree-shakable per-icon component.
...
const FeelingVeryHappyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "feeling-very-happy",
...
FeelingVeryHappyBase.displayName = "FeelingVeryHappy";

export const FeelingVeryHappy = memo(
  FeelingVeryHappyBase,
) as typeof FeelingVeryHappyBase;
FeelingVeryHappy.displayName = "FeelingVeryHappy";
