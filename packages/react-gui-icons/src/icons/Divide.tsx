...
/**
 * "divide" icon — tree-shakable per-icon component.
...
const DivideBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DivideBase.displayName = "Divide";

export const Divide = memo(DivideBase) as typeof DivideBase;
