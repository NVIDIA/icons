...
/**
 * "chat-new" icon — tree-shakable per-icon component.
...
const ChatNewBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ChatNewBase.displayName = "ChatNew";

export const ChatNew = memo(ChatNewBase) as typeof ChatNewBase;
