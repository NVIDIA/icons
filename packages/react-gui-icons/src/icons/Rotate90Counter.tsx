...
/**
 * "rotate-90-counter" icon — tree-shakable per-icon component.
...
const Rotate90CounterBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "rotate-90-counter",
...
Rotate90CounterBase.displayName = "Rotate90Counter";

export const Rotate90Counter = memo(
  Rotate90CounterBase,
) as typeof Rotate90CounterBase;
Rotate90Counter.displayName = "Rotate90Counter";
