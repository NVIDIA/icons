...
/**
 * "shield" icon — tree-shakable per-icon component.
...
const ShieldBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ShieldBase.displayName = "Shield";

export const Shield = memo(ShieldBase) as typeof ShieldBase;
