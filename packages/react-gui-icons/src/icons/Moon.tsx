...
/**
 * "moon" icon — tree-shakable per-icon component.
...
const MoonBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MoonBase.displayName = "Moon";

export const Moon = memo(MoonBase) as typeof MoonBase;
