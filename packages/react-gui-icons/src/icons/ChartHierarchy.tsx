...
/**
 * "chart-hierarchy" icon — tree-shakable per-icon component.
...
const ChartHierarchyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chart-hierarchy",
...
ChartHierarchyBase.displayName = "ChartHierarchy";

export const ChartHierarchy = memo(
  ChartHierarchyBase,
) as typeof ChartHierarchyBase;
ChartHierarchy.displayName = "ChartHierarchy";
