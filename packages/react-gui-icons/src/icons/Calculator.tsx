...
/**
 * "calculator" icon — tree-shakable per-icon component.
...
const CalculatorBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CalculatorBase.displayName = "Calculator";

export const Calculator = memo(CalculatorBase) as typeof CalculatorBase;
