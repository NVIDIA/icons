...
/**
 * "home-off" icon — tree-shakable per-icon component.
...
const HomeOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HomeOffBase.displayName = "HomeOff";

export const HomeOff = memo(HomeOffBase) as typeof HomeOffBase;
HomeOff.displayName = "HomeOff";
