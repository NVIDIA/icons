...
/**
 * "gpu-card-multi" icon — tree-shakable per-icon component.
...
const GpuCardMultiBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GpuCardMultiBase.displayName = "GpuCardMulti";

export const GpuCardMulti = memo(GpuCardMultiBase) as typeof GpuCardMultiBase;
GpuCardMulti.displayName = "GpuCardMulti";
