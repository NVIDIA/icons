...
/**
 * "bed" icon — tree-shakable per-icon component.
...
const BedBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BedBase.displayName = "Bed";

export const Bed = memo(BedBase) as typeof BedBase;
Bed.displayName = "Bed";
