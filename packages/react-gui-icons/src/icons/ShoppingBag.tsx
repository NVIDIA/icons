...
/**
 * "shopping-bag" icon — tree-shakable per-icon component.
...
const ShoppingBagBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ShoppingBagBase.displayName = "ShoppingBag";

export const ShoppingBag = memo(ShoppingBagBase) as typeof ShoppingBagBase;
