...
/**
 * "toolbox" icon — tree-shakable per-icon component.
...
const ToolboxBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ToolboxBase.displayName = "Toolbox";

export const Toolbox = memo(ToolboxBase) as typeof ToolboxBase;
