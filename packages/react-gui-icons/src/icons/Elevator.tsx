...
/**
 * "elevator" icon — tree-shakable per-icon component.
...
const ElevatorBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ElevatorBase.displayName = "Elevator";

export const Elevator = memo(ElevatorBase) as typeof ElevatorBase;
