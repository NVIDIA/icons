...
/**
 * "component" icon — tree-shakable per-icon component.
...
const ComponentBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ComponentBase.displayName = "Component";

export const Component = memo(ComponentBase) as typeof ComponentBase;
