...
/**
 * "moon-off" icon — tree-shakable per-icon component.
...
const MoonOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MoonOffBase.displayName = "MoonOff";

export const MoonOff = memo(MoonOffBase) as typeof MoonOffBase;
MoonOff.displayName = "MoonOff";
