...
/**
 * "2b-left-click" icon — tree-shakable per-icon component.
...
const Icon2BLeftClickBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Icon2BLeftClickBase.displayName = "Icon2BLeftClick";

export const Icon2BLeftClick = memo(
  Icon2BLeftClickBase,
) as typeof Icon2BLeftClickBase;
Icon2BLeftClick.displayName = "Icon2BLeftClick";
