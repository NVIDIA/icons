...
/**
 * "hud" icon — tree-shakable per-icon component.
...
const HudBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HudBase.displayName = "Hud";

export const Hud = memo(HudBase) as typeof HudBase;
Hud.displayName = "Hud";
