...
import { NvidiaMicroGuiIcon, NvidiaMicroGuiIconSprite } from "../src/index.js";
...
const SAMPLE_ICON = "add" as IconName;
...
const SUBJECTS: ReadonlyArray<{
  ...
  {
    label: "per-icon <Add>",
    render: (props: Props) => createElement(Icons.Add as ElementType, props),
  },
  {
    label: "generic <NvidiaMicroGuiIcon>",
    render: (props: Props) =>
      createElement(NvidiaMicroGuiIcon as ElementType, {
...
test("NvidiaMicroGuiIconSprite root stays hidden even if asked otherwise", () => {
  const { svgs } = renderAll(
    createElement(NvidiaMicroGuiIconSprite as ElementType, {
      symbols: [],
      "aria-hidden": undefined,
    }),
  );
