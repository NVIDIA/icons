...
/**
 * "texture" icon — tree-shakable per-icon component.
...
const TextureBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
TextureBase.displayName = "Texture";

export const Texture = memo(TextureBase) as typeof TextureBase;
