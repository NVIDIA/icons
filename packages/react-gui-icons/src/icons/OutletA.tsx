...
/**
 * "outlet-a" icon — tree-shakable per-icon component.
...
const OutletABase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletABase.displayName = "OutletA";

export const OutletA = memo(OutletABase) as typeof OutletABase;
OutletA.displayName = "OutletA";
