...
/**
 * "dvi" icon — tree-shakable per-icon component.
...
const DviBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DviBase.displayName = "Dvi";

export const Dvi = memo(DviBase) as typeof DviBase;
Dvi.displayName = "Dvi";
