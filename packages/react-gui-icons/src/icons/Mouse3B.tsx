...
/**
 * "mouse-3-b" icon — tree-shakable per-icon component.
...
const Mouse3BBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Mouse3BBase.displayName = "Mouse3B";

export const Mouse3B = memo(Mouse3BBase) as typeof Mouse3BBase;
Mouse3B.displayName = "Mouse3B";
