...
/**
 * "pawn" icon — tree-shakable per-icon component.
...
const PawnBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PawnBase.displayName = "Pawn";

export const Pawn = memo(PawnBase) as typeof PawnBase;
