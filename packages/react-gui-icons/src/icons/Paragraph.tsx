...
/**
 * "paragraph" icon — tree-shakable per-icon component.
...
const ParagraphBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Paragraph = memo(ParagraphBase) as typeof ParagraphBase;
