...
/**
 * "scale-up" icon — tree-shakable per-icon component.
...
const ScaleUpBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScaleUpBase.displayName = "ScaleUp";

export const ScaleUp = memo(ScaleUpBase) as typeof ScaleUpBase;
