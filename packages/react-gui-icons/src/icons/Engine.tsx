...
/**
 * "engine" icon — tree-shakable per-icon component.
...
const EngineBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EngineBase.displayName = "Engine";

export const Engine = memo(EngineBase) as typeof EngineBase;
