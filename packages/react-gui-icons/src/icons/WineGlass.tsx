...
/**
 * "wine-glass" icon — tree-shakable per-icon component.
...
const WineGlassBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WineGlassBase.displayName = "WineGlass";

export const WineGlass = memo(WineGlassBase) as typeof WineGlassBase;
