...
/**
 * "mouse-scrollwheel" icon — tree-shakable per-icon component.
...
const MouseScrollwheelBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "mouse-scrollwheel",
...
MouseScrollwheelBase.displayName = "MouseScrollwheel";

export const MouseScrollwheel = memo(
  MouseScrollwheelBase,
) as typeof MouseScrollwheelBase;
