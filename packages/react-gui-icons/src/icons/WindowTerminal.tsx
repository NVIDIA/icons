...
/**
 * "window-terminal" icon — tree-shakable per-icon component.
...
const WindowTerminalBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "window-terminal",
...
WindowTerminalBase.displayName = "WindowTerminal";

export const WindowTerminal = memo(
  WindowTerminalBase,
) as typeof WindowTerminalBase;
WindowTerminal.displayName = "WindowTerminal";
