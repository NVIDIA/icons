...
/**
 * "check" icon — tree-shakable per-icon component.
...
const CheckBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
CheckBase.displayName = "Check";

export const Check = memo(CheckBase) as typeof CheckBase;
