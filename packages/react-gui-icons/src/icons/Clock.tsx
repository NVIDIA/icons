...
/**
 * "clock" icon — tree-shakable per-icon component.
...
const ClockBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ClockBase.displayName = "Clock";

export const Clock = memo(ClockBase) as typeof ClockBase;
