...
/**
 * "arrow-right" icon — tree-shakable per-icon component.
...
const ArrowRightBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
ArrowRightBase.displayName = "ArrowRight";

export const ArrowRight = memo(ArrowRightBase) as typeof ArrowRightBase;
