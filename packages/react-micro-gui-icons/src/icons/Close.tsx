...
/**
 * "close" icon — tree-shakable per-icon component.
...
const CloseBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
CloseBase.displayName = "Close";

export const Close = memo(CloseBase) as typeof CloseBase;
