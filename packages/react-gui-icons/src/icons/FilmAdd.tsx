...
/**
 * "film-add" icon — tree-shakable per-icon component.
...
const FilmAddBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FilmAddBase.displayName = "FilmAdd";

export const FilmAdd = memo(FilmAddBase) as typeof FilmAddBase;
FilmAdd.displayName = "FilmAdd";
