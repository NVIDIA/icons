...
/**
 * "chevron-double-down" icon — tree-shakable per-icon component.
...
const ChevronDoubleDownBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chevron-double-down",
...
ChevronDoubleDownBase.displayName = "ChevronDoubleDown";

export const ChevronDoubleDown = memo(
  ChevronDoubleDownBase,
) as typeof ChevronDoubleDownBase;
