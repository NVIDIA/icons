...
/**
 * "split-file" icon — tree-shakable per-icon component.
...
const SplitFileBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SplitFileBase.displayName = "SplitFile";

export const SplitFile = memo(SplitFileBase) as typeof SplitFileBase;
