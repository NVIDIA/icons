...
/**
 * "shopping-basket" icon — tree-shakable per-icon component.
...
const ShoppingBasketBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "shopping-basket",
...
ShoppingBasketBase.displayName = "ShoppingBasket";

export const ShoppingBasket = memo(
  ShoppingBasketBase,
) as typeof ShoppingBasketBase;
