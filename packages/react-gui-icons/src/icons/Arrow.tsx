...
/**
 * "arrow" icon — tree-shakable per-icon component.
...
const ArrowBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ArrowBase.displayName = "Arrow";

export const Arrow = memo(ArrowBase) as typeof ArrowBase;
