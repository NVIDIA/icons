...
/**
 * "outlet-i" icon — tree-shakable per-icon component.
...
const OutletIBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletIBase.displayName = "OutletI";

export const OutletI = memo(OutletIBase) as typeof OutletIBase;
OutletI.displayName = "OutletI";
