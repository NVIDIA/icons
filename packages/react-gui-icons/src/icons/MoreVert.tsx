...
/**
 * "more-vert" icon — tree-shakable per-icon component.
...
const MoreVertBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MoreVertBase.displayName = "MoreVert";

export const MoreVert = memo(MoreVertBase) as typeof MoreVertBase;
