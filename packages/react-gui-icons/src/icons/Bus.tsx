...
/**
 * "bus" icon — tree-shakable per-icon component.
...
const BusBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BusBase.displayName = "Bus";

export const Bus = memo(BusBase) as typeof BusBase;
Bus.displayName = "Bus";
