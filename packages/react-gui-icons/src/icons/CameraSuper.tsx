...
/**
 * "camera-super" icon — tree-shakable per-icon component.
...
const CameraSuperBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CameraSuperBase.displayName = "CameraSuper";

export const CameraSuper = memo(CameraSuperBase) as typeof CameraSuperBase;
CameraSuper.displayName = "CameraSuper";
