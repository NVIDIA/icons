...
/**
 * "download" icon — tree-shakable per-icon component.
...
const DownloadBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DownloadBase.displayName = "Download";

export const Download = memo(DownloadBase) as typeof DownloadBase;
