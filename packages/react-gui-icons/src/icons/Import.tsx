...
/**
 * "import" icon — tree-shakable per-icon component.
...
const ImportBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ImportBase.displayName = "Import";

export const Import = memo(ImportBase) as typeof ImportBase;
