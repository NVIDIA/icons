...
/**
 * "sort-descending" icon — tree-shakable per-icon component.
...
const SortDescendingBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "sort-descending",
...
SortDescendingBase.displayName = "SortDescending";

export const SortDescending = memo(
  SortDescendingBase,
) as typeof SortDescendingBase;
