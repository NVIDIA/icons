...
/**
 * "plug-usb" icon — tree-shakable per-icon component.
...
const PlugUsbBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PlugUsbBase.displayName = "PlugUsb";

export const PlugUsb = memo(PlugUsbBase) as typeof PlugUsbBase;
PlugUsb.displayName = "PlugUsb";
