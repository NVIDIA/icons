...
/**
 * "grip-mini" icon — tree-shakable per-icon component.
...
const GripMiniBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GripMiniBase.displayName = "GripMini";

export const GripMini = memo(GripMiniBase) as typeof GripMiniBase;
GripMini.displayName = "GripMini";
