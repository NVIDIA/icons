...
/**
 * "rotate-global" icon — tree-shakable per-icon component.
...
const RotateGlobalBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RotateGlobalBase.displayName = "RotateGlobal";

export const RotateGlobal = memo(RotateGlobalBase) as typeof RotateGlobalBase;
RotateGlobal.displayName = "RotateGlobal";
