...
/**
 * "code" icon — tree-shakable per-icon component.
...
const CodeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Code = memo(CodeBase) as typeof CodeBase;
