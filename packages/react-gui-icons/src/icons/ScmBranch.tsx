...
/**
 * "scm-branch" icon — tree-shakable per-icon component.
...
const ScmBranchBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScmBranchBase.displayName = "ScmBranch";

export const ScmBranch = memo(ScmBranchBase) as typeof ScmBranchBase;
ScmBranch.displayName = "ScmBranch";
