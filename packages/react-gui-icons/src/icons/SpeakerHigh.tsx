...
/**
 * "speaker-high" icon — tree-shakable per-icon component.
...
const SpeakerHighBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SpeakerHighBase.displayName = "SpeakerHigh";

export const SpeakerHigh = memo(SpeakerHighBase) as typeof SpeakerHighBase;
