...
/**
 * "numbers" icon — tree-shakable per-icon component.
...
const NumbersBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
NumbersBase.displayName = "Numbers";

export const Numbers = memo(NumbersBase) as typeof NumbersBase;
