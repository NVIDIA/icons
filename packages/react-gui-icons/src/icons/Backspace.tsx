...
/**
 * "backspace" icon — tree-shakable per-icon component.
...
const BackspaceBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BackspaceBase.displayName = "Backspace";

export const Backspace = memo(BackspaceBase) as typeof BackspaceBase;
