...
/**
 * "sword" icon — tree-shakable per-icon component.
...
const SwordBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SwordBase.displayName = "Sword";

export const Sword = memo(SwordBase) as typeof SwordBase;
