...
/**
 * "outlet-k" icon — tree-shakable per-icon component.
...
const OutletKBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletKBase.displayName = "OutletK";

export const OutletK = memo(OutletKBase) as typeof OutletKBase;
OutletK.displayName = "OutletK";
