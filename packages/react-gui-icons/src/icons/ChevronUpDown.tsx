...
/**
 * "chevron-up-down" icon — tree-shakable per-icon component.
...
const ChevronUpDownBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chevron-up-down",
...
ChevronUpDownBase.displayName = "ChevronUpDown";

export const ChevronUpDown = memo(
  ChevronUpDownBase,
) as typeof ChevronUpDownBase;
