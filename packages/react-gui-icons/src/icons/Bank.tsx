...
/**
 * "bank" icon — tree-shakable per-icon component.
...
const BankBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BankBase.displayName = "Bank";

export const Bank = memo(BankBase) as typeof BankBase;
