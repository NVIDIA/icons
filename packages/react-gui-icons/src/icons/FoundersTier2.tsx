...
/**
 * "founders-tier-2" icon — tree-shakable per-icon component.
...
const FoundersTier2Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "founders-tier-2",
...
FoundersTier2Base.displayName = "FoundersTier2";

export const FoundersTier2 = memo(
  FoundersTier2Base,
) as typeof FoundersTier2Base;
FoundersTier2.displayName = "FoundersTier2";
