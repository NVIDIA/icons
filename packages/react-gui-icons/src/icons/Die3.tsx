...
/**
 * "die-3" icon — tree-shakable per-icon component.
...
const Die3Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Die3Base.displayName = "Die3";

export const Die3 = memo(Die3Base) as typeof Die3Base;
Die3.displayName = "Die3";
