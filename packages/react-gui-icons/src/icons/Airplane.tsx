...
/**
 * "airplane" icon — tree-shakable per-icon component.
...
const AirplaneBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AirplaneBase.displayName = "Airplane";

export const Airplane = memo(AirplaneBase) as typeof AirplaneBase;
