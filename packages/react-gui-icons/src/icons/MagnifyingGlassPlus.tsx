...
/**
 * "magnifying-glass-plus" icon — tree-shakable per-icon component.
...
const MagnifyingGlassPlusBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "magnifying-glass-plus",
...
MagnifyingGlassPlusBase.displayName = "MagnifyingGlassPlus";

export const MagnifyingGlassPlus = memo(
  MagnifyingGlassPlusBase,
) as typeof MagnifyingGlassPlusBase;
