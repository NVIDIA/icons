...
/**
 * "founders-tier-3" icon — tree-shakable per-icon component.
...
const FoundersTier3Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "founders-tier-3",
...
FoundersTier3Base.displayName = "FoundersTier3";

export const FoundersTier3 = memo(
  FoundersTier3Base,
) as typeof FoundersTier3Base;
FoundersTier3.displayName = "FoundersTier3";
