...
/**
 * "woman" icon — tree-shakable per-icon component.
...
const WomanBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WomanBase.displayName = "Woman";

export const Woman = memo(WomanBase) as typeof WomanBase;
