...
/**
 * "freehand" icon — tree-shakable per-icon component.
...
const FreehandBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FreehandBase.displayName = "Freehand";

export const Freehand = memo(FreehandBase) as typeof FreehandBase;
