...
/**
 * "upload" icon — tree-shakable per-icon component.
...
const UploadBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Upload = memo(UploadBase) as typeof UploadBase;
