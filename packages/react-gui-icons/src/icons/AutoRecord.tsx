...
/**
 * "auto-record" icon — tree-shakable per-icon component.
...
const AutoRecordBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AutoRecordBase.displayName = "AutoRecord";

export const AutoRecord = memo(AutoRecordBase) as typeof AutoRecordBase;
AutoRecord.displayName = "AutoRecord";
