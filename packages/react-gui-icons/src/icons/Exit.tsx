...
/**
 * "exit" icon — tree-shakable per-icon component.
...
const ExitBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ExitBase.displayName = "Exit";

export const Exit = memo(ExitBase) as typeof ExitBase;
