...
/**
 * "iterate" icon — tree-shakable per-icon component.
...
const IterateBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IterateBase.displayName = "Iterate";

export const Iterate = memo(IterateBase) as typeof IterateBase;
Iterate.displayName = "Iterate";
