...
/**
 * "steering-wheel" icon — tree-shakable per-icon component.
...
const SteeringWheelBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SteeringWheelBase.displayName = "SteeringWheel";

export const SteeringWheel = memo(
  SteeringWheelBase,
) as typeof SteeringWheelBase;
