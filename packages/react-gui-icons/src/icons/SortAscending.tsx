...
/**
 * "sort-ascending" icon — tree-shakable per-icon component.
...
const SortAscendingBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SortAscendingBase.displayName = "SortAscending";

export const SortAscending = memo(
  SortAscendingBase,
) as typeof SortAscendingBase;
