...
/**
 * "feeling-neutral" icon — tree-shakable per-icon component.
...
const FeelingNeutralBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "feeling-neutral",
...
FeelingNeutralBase.displayName = "FeelingNeutral";

export const FeelingNeutral = memo(
  FeelingNeutralBase,
) as typeof FeelingNeutralBase;
FeelingNeutral.displayName = "FeelingNeutral";
