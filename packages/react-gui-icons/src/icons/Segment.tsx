...
/**
 * "segment" icon — tree-shakable per-icon component.
...
const SegmentBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SegmentBase.displayName = "Segment";

export const Segment = memo(SegmentBase) as typeof SegmentBase;
