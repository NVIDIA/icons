...
/**
 * "isp" icon — tree-shakable per-icon component.
...
const IspBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IspBase.displayName = "Isp";

export const Isp = memo(IspBase) as typeof IspBase;
Isp.displayName = "Isp";
