...
/**
 * "fork" icon — tree-shakable per-icon component.
...
const ForkBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ForkBase.displayName = "Fork";

export const Fork = memo(ForkBase) as typeof ForkBase;
