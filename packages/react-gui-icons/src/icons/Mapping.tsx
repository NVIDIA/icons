...
/**
 * "mapping" icon — tree-shakable per-icon component.
...
const MappingBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MappingBase.displayName = "Mapping";

export const Mapping = memo(MappingBase) as typeof MappingBase;
