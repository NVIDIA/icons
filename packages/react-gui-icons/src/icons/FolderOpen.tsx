...
/**
 * "folder-open" icon — tree-shakable per-icon component.
...
const FolderOpenBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FolderOpenBase.displayName = "FolderOpen";

export const FolderOpen = memo(FolderOpenBase) as typeof FolderOpenBase;
