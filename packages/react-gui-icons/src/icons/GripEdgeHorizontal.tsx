...
/**
 * "grip-edge-horizontal" icon — tree-shakable per-icon component.
...
const GripEdgeHorizontalBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "grip-edge-horizontal",
...
GripEdgeHorizontalBase.displayName = "GripEdgeHorizontal";

export const GripEdgeHorizontal = memo(
  GripEdgeHorizontalBase,
) as typeof GripEdgeHorizontalBase;
GripEdgeHorizontal.displayName = "GripEdgeHorizontal";
