...
/**
 * "window-code" icon — tree-shakable per-icon component.
...
const WindowCodeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WindowCodeBase.displayName = "WindowCode";

export const WindowCode = memo(WindowCodeBase) as typeof WindowCodeBase;
WindowCode.displayName = "WindowCode";
