...
/**
 * "layout-list" icon — tree-shakable per-icon component.
...
const LayoutListBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const LayoutList = memo(LayoutListBase) as typeof LayoutListBase;
