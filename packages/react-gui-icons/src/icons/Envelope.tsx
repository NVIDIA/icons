...
/**
 * "envelope" icon — tree-shakable per-icon component.
...
const EnvelopeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EnvelopeBase.displayName = "Envelope";

export const Envelope = memo(EnvelopeBase) as typeof EnvelopeBase;
