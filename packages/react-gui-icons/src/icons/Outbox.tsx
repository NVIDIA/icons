...
/**
 * "outbox" icon — tree-shakable per-icon component.
...
const OutboxBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutboxBase.displayName = "Outbox";

export const Outbox = memo(OutboxBase) as typeof OutboxBase;
