...
/**
 * "eraser" icon — tree-shakable per-icon component.
...
const EraserBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EraserBase.displayName = "Eraser";

export const Eraser = memo(EraserBase) as typeof EraserBase;
