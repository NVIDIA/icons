...
/**
 * "coaxial" icon — tree-shakable per-icon component.
...
const CoaxialBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CoaxialBase.displayName = "Coaxial";

export const Coaxial = memo(CoaxialBase) as typeof CoaxialBase;
Coaxial.displayName = "Coaxial";
