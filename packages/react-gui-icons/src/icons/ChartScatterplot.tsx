...
/**
 * "chart-scatterplot" icon — tree-shakable per-icon component.
...
const ChartScatterplotBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chart-scatterplot",
...
ChartScatterplotBase.displayName = "ChartScatterplot";

export const ChartScatterplot = memo(
  ChartScatterplotBase,
) as typeof ChartScatterplotBase;
ChartScatterplot.displayName = "ChartScatterplot";
