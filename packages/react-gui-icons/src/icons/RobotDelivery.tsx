...
/**
 * "robot-delivery" icon — tree-shakable per-icon component.
...
const RobotDeliveryBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RobotDeliveryBase.displayName = "RobotDelivery";

export const RobotDelivery = memo(
  RobotDeliveryBase,
) as typeof RobotDeliveryBase;
RobotDelivery.displayName = "RobotDelivery";
