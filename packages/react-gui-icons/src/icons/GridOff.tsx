...
/**
 * "grid-off" icon — tree-shakable per-icon component.
...
const GridOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GridOffBase.displayName = "GridOff";

export const GridOff = memo(GridOffBase) as typeof GridOffBase;
