...
/**
 * "founders" icon — tree-shakable per-icon component.
...
const FoundersBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FoundersBase.displayName = "Founders";

export const Founders = memo(FoundersBase) as typeof FoundersBase;
