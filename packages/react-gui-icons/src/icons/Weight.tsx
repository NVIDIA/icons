...
/**
 * "weight" icon — tree-shakable per-icon component.
...
const WeightBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WeightBase.displayName = "Weight";

export const Weight = memo(WeightBase) as typeof WeightBase;
