...
/**
 * "arrow-left-right" icon — tree-shakable per-icon component.
...
const ArrowLeftRightBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "arrow-left-right",
...
ArrowLeftRightBase.displayName = "ArrowLeftRight";

export const ArrowLeftRight = memo(
  ArrowLeftRightBase,
) as typeof ArrowLeftRightBase;
