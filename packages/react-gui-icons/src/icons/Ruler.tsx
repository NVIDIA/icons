...
/**
 * "ruler" icon — tree-shakable per-icon component.
...
const RulerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RulerBase.displayName = "Ruler";

export const Ruler = memo(RulerBase) as typeof RulerBase;
