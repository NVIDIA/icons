...
/**
 * "flower" icon — tree-shakable per-icon component.
...
const FlowerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FlowerBase.displayName = "Flower";

export const Flower = memo(FlowerBase) as typeof FlowerBase;
