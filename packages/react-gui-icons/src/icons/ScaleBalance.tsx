...
/**
 * "scale-balance" icon — tree-shakable per-icon component.
...
const ScaleBalanceBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScaleBalanceBase.displayName = "ScaleBalance";

export const ScaleBalance = memo(ScaleBalanceBase) as typeof ScaleBalanceBase;
