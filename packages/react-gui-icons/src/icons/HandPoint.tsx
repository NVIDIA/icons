...
/**
 * "hand-point" icon — tree-shakable per-icon component.
...
const HandPointBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HandPointBase.displayName = "HandPoint";

export const HandPoint = memo(HandPointBase) as typeof HandPointBase;
