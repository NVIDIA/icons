...
/**
 * "diamond-off" icon — tree-shakable per-icon component.
...
const DiamondOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DiamondOffBase.displayName = "DiamondOff";

export const DiamondOff = memo(DiamondOffBase) as typeof DiamondOffBase;
DiamondOff.displayName = "DiamondOff";
