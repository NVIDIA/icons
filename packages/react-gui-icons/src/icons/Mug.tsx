...
/**
 * "mug" icon — tree-shakable per-icon component.
...
const MugBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MugBase.displayName = "Mug";

export const Mug = memo(MugBase) as typeof MugBase;
Mug.displayName = "Mug";
