...
/**
 * "bandaid" icon — tree-shakable per-icon component.
...
const BandaidBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BandaidBase.displayName = "Bandaid";

export const Bandaid = memo(BandaidBase) as typeof BandaidBase;
