...
/**
 * "dolly" icon — tree-shakable per-icon component.
...
const DollyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DollyBase.displayName = "Dolly";

export const Dolly = memo(DollyBase) as typeof DollyBase;
