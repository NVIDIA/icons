...
/**
 * "display-row" icon — tree-shakable per-icon component.
...
const DisplayRowBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DisplayRowBase.displayName = "DisplayRow";

export const DisplayRow = memo(DisplayRowBase) as typeof DisplayRowBase;
