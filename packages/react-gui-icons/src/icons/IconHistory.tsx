...
/**
 * "history" icon — tree-shakable per-icon component.
...
const IconHistoryBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IconHistoryBase.displayName = "IconHistory";

export const IconHistory = memo(IconHistoryBase) as typeof IconHistoryBase;
