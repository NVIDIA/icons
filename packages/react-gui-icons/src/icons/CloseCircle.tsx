...
/**
 * "close-circle" icon — tree-shakable per-icon component.
...
const CloseCircleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CloseCircleBase.displayName = "CloseCircle";

export const CloseCircle = memo(CloseCircleBase) as typeof CloseCircleBase;
