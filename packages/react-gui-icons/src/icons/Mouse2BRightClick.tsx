...
/**
 * "mouse-2b-right-click" icon — tree-shakable per-icon component.
...
const Mouse2BRightClickBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "mouse-2b-right-click",
...
Mouse2BRightClickBase.displayName = "Mouse2BRightClick";

export const Mouse2BRightClick = memo(
  Mouse2BRightClickBase,
) as typeof Mouse2BRightClickBase;
Mouse2BRightClick.displayName = "Mouse2BRightClick";
