...
/**
 * "baby" icon — tree-shakable per-icon component.
...
const BabyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BabyBase.displayName = "Baby";

export const Baby = memo(BabyBase) as typeof BabyBase;
