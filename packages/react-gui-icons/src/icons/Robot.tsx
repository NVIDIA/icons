...
/**
 * "robot" icon — tree-shakable per-icon component.
...
const RobotBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RobotBase.displayName = "Robot";

export const Robot = memo(RobotBase) as typeof RobotBase;
