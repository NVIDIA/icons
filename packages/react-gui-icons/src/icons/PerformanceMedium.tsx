...
/**
 * "performance-medium" icon — tree-shakable per-icon component.
...
const PerformanceMediumBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "performance-medium",
...
PerformanceMediumBase.displayName = "PerformanceMedium";

export const PerformanceMedium = memo(
  PerformanceMediumBase,
) as typeof PerformanceMediumBase;
PerformanceMedium.displayName = "PerformanceMedium";
