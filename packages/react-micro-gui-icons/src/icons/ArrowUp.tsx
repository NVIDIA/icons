...
/**
 * "arrow-up" icon — tree-shakable per-icon component.
...
const ArrowUpBase = forwardRef<SVGSVGElement, NvidiaMicroGuiIconProps>(
...
ArrowUpBase.displayName = "ArrowUp";

export const ArrowUp = memo(ArrowUpBase) as typeof ArrowUpBase;
