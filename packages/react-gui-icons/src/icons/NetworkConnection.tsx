...
/**
 * "network-connection" icon — tree-shakable per-icon component.
...
const NetworkConnectionBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "network-connection",
...
NetworkConnectionBase.displayName = "NetworkConnection";

export const NetworkConnection = memo(
  NetworkConnectionBase,
) as typeof NetworkConnectionBase;
