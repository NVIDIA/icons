...
/**
 * "feeling-sad" icon — tree-shakable per-icon component.
...
const FeelingSadBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FeelingSadBase.displayName = "FeelingSad";

export const FeelingSad = memo(FeelingSadBase) as typeof FeelingSadBase;
FeelingSad.displayName = "FeelingSad";
