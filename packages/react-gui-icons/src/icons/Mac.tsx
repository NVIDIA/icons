...
/**
 * "mac" icon — tree-shakable per-icon component.
...
const MacBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MacBase.displayName = "Mac";

export const Mac = memo(MacBase) as typeof MacBase;
Mac.displayName = "Mac";
