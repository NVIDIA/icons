...
/**
 * "sun-low" icon — tree-shakable per-icon component.
...
const SunLowBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SunLowBase.displayName = "SunLow";

export const SunLow = memo(SunLowBase) as typeof SunLowBase;
SunLow.displayName = "SunLow";
