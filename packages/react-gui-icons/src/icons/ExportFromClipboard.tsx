...
/**
 * "export-from-clipboard" icon — tree-shakable per-icon component.
...
const ExportFromClipboardBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "export-from-clipboard",
...
ExportFromClipboardBase.displayName = "ExportFromClipboard";

export const ExportFromClipboard = memo(
  ExportFromClipboardBase,
) as typeof ExportFromClipboardBase;
ExportFromClipboard.displayName = "ExportFromClipboard";
