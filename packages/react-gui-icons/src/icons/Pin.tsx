...
/**
 * "pin" icon — tree-shakable per-icon component.
...
const PinBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PinBase.displayName = "Pin";

export const Pin = memo(PinBase) as typeof PinBase;
Pin.displayName = "Pin";
