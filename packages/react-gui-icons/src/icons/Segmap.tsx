...
/**
 * "segmap" icon — tree-shakable per-icon component.
...
const SegmapBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SegmapBase.displayName = "Segmap";

export const Segmap = memo(SegmapBase) as typeof SegmapBase;
Segmap.displayName = "Segmap";
