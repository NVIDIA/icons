...
/**
 * "group" icon — tree-shakable per-icon component.
...
const GroupBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GroupBase.displayName = "Group";

export const Group = memo(GroupBase) as typeof GroupBase;
