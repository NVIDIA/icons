...
/**
 * "thumb-up" icon — tree-shakable per-icon component.
...
const ThumbUpBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ThumbUpBase.displayName = "ThumbUp";

export const ThumbUp = memo(ThumbUpBase) as typeof ThumbUpBase;
