...
/**
 * "firecracker" icon — tree-shakable per-icon component.
...
const FirecrackerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FirecrackerBase.displayName = "Firecracker";

export const Firecracker = memo(FirecrackerBase) as typeof FirecrackerBase;
