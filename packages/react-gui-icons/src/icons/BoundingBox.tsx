...
/**
 * "bounding-box" icon — tree-shakable per-icon component.
...
const BoundingBoxBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BoundingBoxBase.displayName = "BoundingBox";

export const BoundingBox = memo(BoundingBoxBase) as typeof BoundingBoxBase;
