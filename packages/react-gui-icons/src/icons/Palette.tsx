...
/**
 * "palette" icon — tree-shakable per-icon component.
...
const PaletteBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PaletteBase.displayName = "Palette";

export const Palette = memo(PaletteBase) as typeof PaletteBase;
