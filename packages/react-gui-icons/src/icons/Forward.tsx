...
/**
 * "forward" icon — tree-shakable per-icon component.
...
const ForwardBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ForwardBase.displayName = "Forward";

export const Forward = memo(ForwardBase) as typeof ForwardBase;
