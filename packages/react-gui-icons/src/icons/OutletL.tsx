...
/**
 * "outlet-l" icon — tree-shakable per-icon component.
...
const OutletLBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletLBase.displayName = "OutletL";

export const OutletL = memo(OutletLBase) as typeof OutletLBase;
OutletL.displayName = "OutletL";
