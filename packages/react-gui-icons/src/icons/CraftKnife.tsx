...
/**
 * "craft-knife" icon — tree-shakable per-icon component.
...
const CraftKnifeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CraftKnifeBase.displayName = "CraftKnife";

export const CraftKnife = memo(CraftKnifeBase) as typeof CraftKnifeBase;
CraftKnife.displayName = "CraftKnife";
