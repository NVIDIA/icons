...
/**
 * "bookmark-off" icon — tree-shakable per-icon component.
...
const BookmarkOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BookmarkOffBase.displayName = "BookmarkOff";

export const BookmarkOff = memo(BookmarkOffBase) as typeof BookmarkOffBase;
