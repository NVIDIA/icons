...
/**
 * "briefcase" icon — tree-shakable per-icon component.
...
const BriefcaseBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BriefcaseBase.displayName = "Briefcase";

export const Briefcase = memo(BriefcaseBase) as typeof BriefcaseBase;
