...
/**
 * "layout-grid" icon — tree-shakable per-icon component.
...
const LayoutGridBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const LayoutGrid = memo(LayoutGridBase) as typeof LayoutGridBase;
