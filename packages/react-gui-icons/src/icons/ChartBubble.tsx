...
/**
 * "chart-bubble" icon — tree-shakable per-icon component.
...
const ChartBubbleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ChartBubbleBase.displayName = "ChartBubble";

export const ChartBubble = memo(ChartBubbleBase) as typeof ChartBubbleBase;
