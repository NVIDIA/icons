...
/**
 * "datacenter" icon — tree-shakable per-icon component.
...
const DatacenterBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DatacenterBase.displayName = "Datacenter";

export const Datacenter = memo(DatacenterBase) as typeof DatacenterBase;
