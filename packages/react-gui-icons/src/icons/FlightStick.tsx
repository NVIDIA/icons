...
/**
 * "flight-stick" icon — tree-shakable per-icon component.
...
const FlightStickBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FlightStickBase.displayName = "FlightStick";

export const FlightStick = memo(FlightStickBase) as typeof FlightStickBase;
FlightStick.displayName = "FlightStick";
