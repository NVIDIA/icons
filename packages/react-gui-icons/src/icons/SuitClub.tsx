...
/**
 * "suit-club" icon — tree-shakable per-icon component.
...
const SuitClubBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SuitClubBase.displayName = "SuitClub";

export const SuitClub = memo(SuitClubBase) as typeof SuitClubBase;
