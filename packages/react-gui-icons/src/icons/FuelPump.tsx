...
/**
 * "fuel-pump" icon — tree-shakable per-icon component.
...
const FuelPumpBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FuelPumpBase.displayName = "FuelPump";

export const FuelPump = memo(FuelPumpBase) as typeof FuelPumpBase;
