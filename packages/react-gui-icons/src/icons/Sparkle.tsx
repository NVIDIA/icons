...
/**
 * "sparkle" icon — tree-shakable per-icon component.
...
const SparkleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SparkleBase.displayName = "Sparkle";

export const Sparkle = memo(SparkleBase) as typeof SparkleBase;
