...
/**
 * "library" icon — tree-shakable per-icon component.
...
const LibraryBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LibraryBase.displayName = "Library";

export const Library = memo(LibraryBase) as typeof LibraryBase;
