...
/**
 * "forward-10" icon — tree-shakable per-icon component.
...
const Forward10Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Forward10Base.displayName = "Forward10";

export const Forward10 = memo(Forward10Base) as typeof Forward10Base;
