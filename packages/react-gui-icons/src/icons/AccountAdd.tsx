...
/**
 * "account-add" icon — tree-shakable per-icon component.
...
const AccountAddBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AccountAddBase.displayName = "AccountAdd";

export const AccountAdd = memo(AccountAddBase) as typeof AccountAddBase;
AccountAdd.displayName = "AccountAdd";
