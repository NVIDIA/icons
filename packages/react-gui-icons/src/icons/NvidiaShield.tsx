...
/**
 * "nvidia-shield" icon — tree-shakable per-icon component.
...
const NvidiaShieldBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
NvidiaShieldBase.displayName = "NvidiaShield";

export const NvidiaShield = memo(NvidiaShieldBase) as typeof NvidiaShieldBase;
NvidiaShield.displayName = "NvidiaShield";
