...
/**
 * "window-grid" icon — tree-shakable per-icon component.
...
const WindowGridBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WindowGridBase.displayName = "WindowGrid";

export const WindowGrid = memo(WindowGridBase) as typeof WindowGridBase;
