...
/**
 * "chevron-double-right" icon — tree-shakable per-icon component.
...
const ChevronDoubleRightBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chevron-double-right",
...
ChevronDoubleRightBase.displayName = "ChevronDoubleRight";

export const ChevronDoubleRight = memo(
  ChevronDoubleRightBase,
) as typeof ChevronDoubleRightBase;
