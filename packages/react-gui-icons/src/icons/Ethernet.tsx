...
/**
 * "ethernet" icon — tree-shakable per-icon component.
...
const EthernetBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EthernetBase.displayName = "Ethernet";

export const Ethernet = memo(EthernetBase) as typeof EthernetBase;
