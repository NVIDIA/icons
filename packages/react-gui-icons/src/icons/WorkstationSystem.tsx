...
/**
 * "workstation-system" icon — tree-shakable per-icon component.
...
const WorkstationSystemBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "workstation-system",
...
WorkstationSystemBase.displayName = "WorkstationSystem";

export const WorkstationSystem = memo(
  WorkstationSystemBase,
) as typeof WorkstationSystemBase;
WorkstationSystem.displayName = "WorkstationSystem";
