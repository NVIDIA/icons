...
/**
 * "list-number" icon — tree-shakable per-icon component.
...
const ListNumberBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ListNumberBase.displayName = "ListNumber";

export const ListNumber = memo(ListNumberBase) as typeof ListNumberBase;
