...
/**
 * "timer" icon — tree-shakable per-icon component.
...
const TimerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
TimerBase.displayName = "Timer";

export const Timer = memo(TimerBase) as typeof TimerBase;
