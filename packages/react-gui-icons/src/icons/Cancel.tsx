...
/**
 * "cancel" icon — tree-shakable per-icon component.
...
const CancelBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CancelBase.displayName = "Cancel";

export const Cancel = memo(CancelBase) as typeof CancelBase;
