...
/**
 * "check-multi-circle" icon — tree-shakable per-icon component.
...
const CheckMultiCircleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "check-multi-circle",
...
CheckMultiCircleBase.displayName = "CheckMultiCircle";

export const CheckMultiCircle = memo(
  CheckMultiCircleBase,
) as typeof CheckMultiCircleBase;
CheckMultiCircle.displayName = "CheckMultiCircle";
