...
/**
 * "bluetooth" icon — tree-shakable per-icon component.
...
const BluetoothBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BluetoothBase.displayName = "Bluetooth";

export const Bluetooth = memo(BluetoothBase) as typeof BluetoothBase;
