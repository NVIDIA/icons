...
/**
 * "cloud" icon — tree-shakable per-icon component.
...
const CloudBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CloudBase.displayName = "Cloud";

export const Cloud = memo(CloudBase) as typeof CloudBase;
