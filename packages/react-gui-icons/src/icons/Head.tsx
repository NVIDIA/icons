...
/**
 * "head" icon — tree-shakable per-icon component.
...
const HeadBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HeadBase.displayName = "Head";

export const Head = memo(HeadBase) as typeof HeadBase;
