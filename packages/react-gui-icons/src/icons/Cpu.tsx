...
/**
 * "cpu" icon — tree-shakable per-icon component.
...
const CpuBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CpuBase.displayName = "Cpu";

export const Cpu = memo(CpuBase) as typeof CpuBase;
Cpu.displayName = "Cpu";
