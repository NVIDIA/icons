...
/**
 * "platformer" icon — tree-shakable per-icon component.
...
const PlatformerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PlatformerBase.displayName = "Platformer";

export const Platformer = memo(PlatformerBase) as typeof PlatformerBase;
Platformer.displayName = "Platformer";
