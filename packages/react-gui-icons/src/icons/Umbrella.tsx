...
/**
 * "umbrella" icon — tree-shakable per-icon component.
...
const UmbrellaBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
UmbrellaBase.displayName = "Umbrella";

export const Umbrella = memo(UmbrellaBase) as typeof UmbrellaBase;
