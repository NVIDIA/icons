...
/**
 * "ship" icon — tree-shakable per-icon component.
...
const ShipBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ShipBase.displayName = "Ship";

export const Ship = memo(ShipBase) as typeof ShipBase;
