...
/**
 * "chevron-double-left" icon — tree-shakable per-icon component.
...
const ChevronDoubleLeftBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chevron-double-left",
...
ChevronDoubleLeftBase.displayName = "ChevronDoubleLeft";

export const ChevronDoubleLeft = memo(
  ChevronDoubleLeftBase,
) as typeof ChevronDoubleLeftBase;
