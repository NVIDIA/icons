...
/**
 * "stone" icon — tree-shakable per-icon component.
...
const StoneBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
StoneBase.displayName = "Stone";

export const Stone = memo(StoneBase) as typeof StoneBase;
