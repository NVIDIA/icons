...
/**
 * "compass" icon — tree-shakable per-icon component.
...
const CompassBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CompassBase.displayName = "Compass";

export const Compass = memo(CompassBase) as typeof CompassBase;
