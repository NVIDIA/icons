...
/**
 * "sin-wave" icon — tree-shakable per-icon component.
...
const SinWaveBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SinWaveBase.displayName = "SinWave";

export const SinWave = memo(SinWaveBase) as typeof SinWaveBase;
SinWave.displayName = "SinWave";
