...
/**
 * "sd-card" icon — tree-shakable per-icon component.
...
const SdCardBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SdCardBase.displayName = "SdCard";

export const SdCard = memo(SdCardBase) as typeof SdCardBase;
