...
/**
 * "tablet" icon — tree-shakable per-icon component.
...
const TabletBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
TabletBase.displayName = "Tablet";

export const Tablet = memo(TabletBase) as typeof TabletBase;
