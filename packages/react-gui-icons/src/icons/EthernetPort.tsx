...
/**
 * "ethernet-port" icon — tree-shakable per-icon component.
...
const EthernetPortBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EthernetPortBase.displayName = "EthernetPort";

export const EthernetPort = memo(EthernetPortBase) as typeof EthernetPortBase;
