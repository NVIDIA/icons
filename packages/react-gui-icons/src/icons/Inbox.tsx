...
/**
 * "inbox" icon — tree-shakable per-icon component.
...
const InboxBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
InboxBase.displayName = "Inbox";

export const Inbox = memo(InboxBase) as typeof InboxBase;
