...
/**
 * "display-column" icon — tree-shakable per-icon component.
...
const DisplayColumnBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DisplayColumnBase.displayName = "DisplayColumn";

export const DisplayColumn = memo(
  DisplayColumnBase,
) as typeof DisplayColumnBase;
