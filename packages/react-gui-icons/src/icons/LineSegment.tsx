...
/**
 * "line-segment" icon — tree-shakable per-icon component.
...
const LineSegmentBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LineSegmentBase.displayName = "LineSegment";

export const LineSegment = memo(LineSegmentBase) as typeof LineSegmentBase;
