...
/**
 * "not-equal" icon — tree-shakable per-icon component.
...
const NotEqualBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
NotEqualBase.displayName = "NotEqual";

export const NotEqual = memo(NotEqualBase) as typeof NotEqualBase;
