...
/**
 * "highlighter" icon — tree-shakable per-icon component.
...
const HighlighterBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HighlighterBase.displayName = "Highlighter";

export const Highlighter = memo(HighlighterBase) as typeof HighlighterBase;
