...
/**
 * "scale" icon — tree-shakable per-icon component.
...
const ScaleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScaleBase.displayName = "Scale";

export const Scale = memo(ScaleBase) as typeof ScaleBase;
