...
/**
 * "easel" icon — tree-shakable per-icon component.
...
const EaselBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EaselBase.displayName = "Easel";

export const Easel = memo(EaselBase) as typeof EaselBase;
