...
/**
 * "grip-area" icon — tree-shakable per-icon component.
...
const GripAreaBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GripAreaBase.displayName = "GripArea";

export const GripArea = memo(GripAreaBase) as typeof GripAreaBase;
GripArea.displayName = "GripArea";
