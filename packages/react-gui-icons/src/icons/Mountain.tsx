...
/**
 * "mountain" icon — tree-shakable per-icon component.
...
const MountainBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MountainBase.displayName = "Mountain";

export const Mountain = memo(MountainBase) as typeof MountainBase;
