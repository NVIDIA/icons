...
/**
 * "list-checkmark" icon — tree-shakable per-icon component.
...
const ListCheckmarkBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ListCheckmarkBase.displayName = "ListCheckmark";

export const ListCheckmark = memo(
  ListCheckmarkBase,
) as typeof ListCheckmarkBase;
ListCheckmark.displayName = "ListCheckmark";
