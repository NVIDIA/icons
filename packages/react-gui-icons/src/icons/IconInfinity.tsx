...
/**
 * "infinity" icon — tree-shakable per-icon component.
...
const IconInfinityBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IconInfinityBase.displayName = "IconInfinity";

export const IconInfinity = memo(IconInfinityBase) as typeof IconInfinityBase;
