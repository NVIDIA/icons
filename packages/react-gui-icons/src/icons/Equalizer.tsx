...
/**
 * "equalizer" icon — tree-shakable per-icon component.
...
const EqualizerBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EqualizerBase.displayName = "Equalizer";

export const Equalizer = memo(EqualizerBase) as typeof EqualizerBase;
