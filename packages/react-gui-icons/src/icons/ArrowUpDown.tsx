...
/**
 * "arrow-up-down" icon — tree-shakable per-icon component.
...
const ArrowUpDownBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ArrowUpDownBase.displayName = "ArrowUpDown";

export const ArrowUpDown = memo(ArrowUpDownBase) as typeof ArrowUpDownBase;
