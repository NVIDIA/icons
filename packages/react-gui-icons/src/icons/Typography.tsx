...
/**
 * "typography" icon — tree-shakable per-icon component.
...
const TypographyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Typography = memo(TypographyBase) as typeof TypographyBase;
