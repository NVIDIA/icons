...
/**
 * "outlet-e" icon — tree-shakable per-icon component.
...
const OutletEBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletEBase.displayName = "OutletE";

export const OutletE = memo(OutletEBase) as typeof OutletEBase;
OutletE.displayName = "OutletE";
