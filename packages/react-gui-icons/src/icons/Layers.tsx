...
/**
 * "layers" icon — tree-shakable per-icon component.
...
const LayersBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LayersBase.displayName = "Layers";

export const Layers = memo(LayersBase) as typeof LayersBase;
