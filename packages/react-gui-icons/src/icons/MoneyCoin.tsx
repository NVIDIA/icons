...
/**
 * "money-coin" icon — tree-shakable per-icon component.
...
const MoneyCoinBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MoneyCoinBase.displayName = "MoneyCoin";

export const MoneyCoin = memo(MoneyCoinBase) as typeof MoneyCoinBase;
