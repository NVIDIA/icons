...
/**
 * "reply" icon — tree-shakable per-icon component.
...
const ReplyBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ReplyBase.displayName = "Reply";

export const Reply = memo(ReplyBase) as typeof ReplyBase;
