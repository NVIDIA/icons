...
/**
 * "graph-node-connect" icon — tree-shakable per-icon component.
...
const GraphNodeConnectBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "graph-node-connect",
...
GraphNodeConnectBase.displayName = "GraphNodeConnect";

export const GraphNodeConnect = memo(
  GraphNodeConnectBase,
) as typeof GraphNodeConnectBase;
GraphNodeConnect.displayName = "GraphNodeConnect";
