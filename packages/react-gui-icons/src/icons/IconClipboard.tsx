...
/**
 * "clipboard" icon — tree-shakable per-icon component.
...
const IconClipboardBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IconClipboardBase.displayName = "IconClipboard";

export const IconClipboard = memo(
  IconClipboardBase,
) as typeof IconClipboardBase;
