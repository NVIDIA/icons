...
/**
 * "retry" icon — tree-shakable per-icon component.
...
const RetryBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RetryBase.displayName = "Retry";

export const Retry = memo(RetryBase) as typeof RetryBase;
