...
/**
 * "rename" icon — tree-shakable per-icon component.
...
const RenameBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
RenameBase.displayName = "Rename";

export const Rename = memo(RenameBase) as typeof RenameBase;
