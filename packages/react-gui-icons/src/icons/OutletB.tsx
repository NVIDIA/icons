...
/**
 * "outlet-b" icon — tree-shakable per-icon component.
...
const OutletBBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletBBase.displayName = "OutletB";

export const OutletB = memo(OutletBBase) as typeof OutletBBase;
OutletB.displayName = "OutletB";
