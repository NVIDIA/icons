...
/**
 * "grip-edge-vertical" icon — tree-shakable per-icon component.
...
const GripEdgeVerticalBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "grip-edge-vertical",
...
GripEdgeVerticalBase.displayName = "GripEdgeVertical";

export const GripEdgeVertical = memo(
  GripEdgeVerticalBase,
) as typeof GripEdgeVerticalBase;
GripEdgeVertical.displayName = "GripEdgeVertical";
