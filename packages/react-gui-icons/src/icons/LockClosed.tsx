...
/**
 * "lock-closed" icon — tree-shakable per-icon component.
...
const LockClosedBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LockClosedBase.displayName = "LockClosed";

export const LockClosed = memo(LockClosedBase) as typeof LockClosedBase;
