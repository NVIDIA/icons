...
/**
 * "grid" icon — tree-shakable per-icon component.
...
const GridBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Grid = memo(GridBase) as typeof GridBase;
