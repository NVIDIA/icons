...
/**
 * "denoise" icon — tree-shakable per-icon component.
...
const DenoiseBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DenoiseBase.displayName = "Denoise";

export const Denoise = memo(DenoiseBase) as typeof DenoiseBase;
