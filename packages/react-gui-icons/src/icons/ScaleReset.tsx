...
/**
 * "scale-reset" icon — tree-shakable per-icon component.
...
const ScaleResetBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScaleResetBase.displayName = "ScaleReset";

export const ScaleReset = memo(ScaleResetBase) as typeof ScaleResetBase;
ScaleReset.displayName = "ScaleReset";
