...
/**
 * "split" icon — tree-shakable per-icon component.
...
const SplitBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
SplitBase.displayName = "Split";

export const Split = memo(SplitBase) as typeof SplitBase;
