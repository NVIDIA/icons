...
/**
 * "feedback" icon — tree-shakable per-icon component.
...
const FeedbackBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Feedback = memo(FeedbackBase) as typeof FeedbackBase;
