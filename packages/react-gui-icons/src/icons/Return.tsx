...
/**
 * "return" icon — tree-shakable per-icon component.
...
const ReturnBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ReturnBase.displayName = "Return";

export const Return = memo(ReturnBase) as typeof ReturnBase;
