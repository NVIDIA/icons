...
/**
 * "bell-off" icon — tree-shakable per-icon component.
...
const BellOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BellOffBase.displayName = "BellOff";

export const BellOff = memo(BellOffBase) as typeof BellOffBase;
