...
/**
 * "math" icon — tree-shakable per-icon component.
...
const IconMathBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IconMathBase.displayName = "IconMath";

export const IconMath = memo(IconMathBase) as typeof IconMathBase;
IconMath.displayName = "IconMath";
