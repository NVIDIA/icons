...
/**
 * "scm-merge" icon — tree-shakable per-icon component.
...
const ScmMergeBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ScmMergeBase.displayName = "ScmMerge";

export const ScmMerge = memo(ScmMergeBase) as typeof ScmMergeBase;
ScmMerge.displayName = "ScmMerge";
