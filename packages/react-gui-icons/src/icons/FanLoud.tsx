...
/**
 * "fan-loud" icon — tree-shakable per-icon component.
...
const FanLoudBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
FanLoudBase.displayName = "FanLoud";

export const FanLoud = memo(FanLoudBase) as typeof FanLoudBase;
FanLoud.displayName = "FanLoud";
