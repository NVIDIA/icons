...
/**
 * "weather-partial-cloud-day" icon — tree-shakable per-icon component.
...
const WeatherPartialCloudDayBase = forwardRef<
  SVGSVGElement,
  NvidiaGuiIconProps
>(({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
  ...
  return createElement(
    "svg",
    {
      ...
      "data-icon-name": "weather-partial-cloud-day",
...
WeatherPartialCloudDayBase.displayName = "WeatherPartialCloudDay";

export const WeatherPartialCloudDay = memo(
  WeatherPartialCloudDayBase,
) as typeof WeatherPartialCloudDayBase;
WeatherPartialCloudDay.displayName = "WeatherPartialCloudDay";
