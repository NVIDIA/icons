...
/**
 * "man" icon — tree-shakable per-icon component.
...
const ManBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ManBase.displayName = "Man";

export const Man = memo(ManBase) as typeof ManBase;
Man.displayName = "Man";
