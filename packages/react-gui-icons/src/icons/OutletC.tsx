...
/**
 * "outlet-c" icon — tree-shakable per-icon component.
...
const OutletCBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletCBase.displayName = "OutletC";

export const OutletC = memo(OutletCBase) as typeof OutletCBase;
OutletC.displayName = "OutletC";
