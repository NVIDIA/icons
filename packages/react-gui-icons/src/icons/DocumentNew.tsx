...
/**
 * "document-new" icon — tree-shakable per-icon component.
...
const DocumentNewBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DocumentNewBase.displayName = "DocumentNew";

export const DocumentNew = memo(DocumentNewBase) as typeof DocumentNewBase;
