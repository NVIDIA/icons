...
/**
 * "display-share" icon — tree-shakable per-icon component.
...
const DisplayShareBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DisplayShareBase.displayName = "DisplayShare";

export const DisplayShare = memo(DisplayShareBase) as typeof DisplayShareBase;
DisplayShare.displayName = "DisplayShare";
