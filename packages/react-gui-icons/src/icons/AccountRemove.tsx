...
/**
 * "account-remove" icon — tree-shakable per-icon component.
...
const AccountRemoveBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AccountRemoveBase.displayName = "AccountRemove";

export const AccountRemove = memo(
  AccountRemoveBase,
) as typeof AccountRemoveBase;
