...
/**
 * "drive-usb-off" icon — tree-shakable per-icon component.
...
const DriveUsbOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DriveUsbOffBase.displayName = "DriveUsbOff";

export const DriveUsbOff = memo(DriveUsbOffBase) as typeof DriveUsbOffBase;
DriveUsbOff.displayName = "DriveUsbOff";
