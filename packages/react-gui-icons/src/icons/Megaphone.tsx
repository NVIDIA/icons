...
/**
 * "megaphone" icon — tree-shakable per-icon component.
...
const MegaphoneBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
MegaphoneBase.displayName = "Megaphone";

export const Megaphone = memo(MegaphoneBase) as typeof MegaphoneBase;
