...
/**
 * "outlet-h" icon — tree-shakable per-icon component.
...
const OutletHBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
OutletHBase.displayName = "OutletH";

export const OutletH = memo(OutletHBase) as typeof OutletHBase;
OutletH.displayName = "OutletH";
