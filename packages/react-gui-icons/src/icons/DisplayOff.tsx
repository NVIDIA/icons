...
/**
 * "display-off" icon — tree-shakable per-icon component.
...
const DisplayOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
DisplayOffBase.displayName = "DisplayOff";

export const DisplayOff = memo(DisplayOffBase) as typeof DisplayOffBase;
DisplayOff.displayName = "DisplayOff";
