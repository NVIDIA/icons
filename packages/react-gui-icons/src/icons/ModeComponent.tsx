...
/**
 * "mode-component" icon — tree-shakable per-icon component.
...
const ModeComponentBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ModeComponentBase.displayName = "ModeComponent";

export const ModeComponent = memo(
  ModeComponentBase,
) as typeof ModeComponentBase;
ModeComponent.displayName = "ModeComponent";
