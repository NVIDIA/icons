...
/**
 * "share" icon — tree-shakable per-icon component.
...
const ShareBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ShareBase.displayName = "Share";

export const Share = memo(ShareBase) as typeof ShareBase;
