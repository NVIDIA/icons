...
/**
 * "replay-off" icon — tree-shakable per-icon component.
...
const ReplayOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ReplayOffBase.displayName = "ReplayOff";

export const ReplayOff = memo(ReplayOffBase) as typeof ReplayOffBase;
ReplayOff.displayName = "ReplayOff";
