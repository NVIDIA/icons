...
/**
 * "chat-multi" icon — tree-shakable per-icon component.
...
const ChatMultiBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ChatMultiBase.displayName = "ChatMulti";

export const ChatMulti = memo(ChatMultiBase) as typeof ChatMultiBase;
ChatMulti.displayName = "ChatMulti";
