...
/**
 * "lamp" icon — tree-shakable per-icon component.
...
const LampBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
LampBase.displayName = "Lamp";

export const Lamp = memo(LampBase) as typeof LampBase;
