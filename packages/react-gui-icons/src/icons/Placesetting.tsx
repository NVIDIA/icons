...
/**
 * "placesetting" icon — tree-shakable per-icon component.
...
const PlacesettingBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PlacesettingBase.displayName = "Placesetting";

export const Placesetting = memo(PlacesettingBase) as typeof PlacesettingBase;
