...
/**
 * "tablet-off" icon — tree-shakable per-icon component.
...
const TabletOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
TabletOffBase.displayName = "TabletOff";

export const TabletOff = memo(TabletOffBase) as typeof TabletOffBase;
TabletOff.displayName = "TabletOff";
