...
/**
 * "enter" icon — tree-shakable per-icon component.
...
const EnterBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
EnterBase.displayName = "Enter";

export const Enter = memo(EnterBase) as typeof EnterBase;
