...
/**
 * "image" icon — tree-shakable per-icon component.
...
const IconImageBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
IconImageBase.displayName = "IconImage";

export const IconImage = memo(IconImageBase) as typeof IconImageBase;
