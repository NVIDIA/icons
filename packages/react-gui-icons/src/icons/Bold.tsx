...
/**
 * "bold" icon — tree-shakable per-icon component.
...
const BoldBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BoldBase.displayName = "Bold";

export const Bold = memo(BoldBase) as typeof BoldBase;
