...
/**
 * "add-circle" icon — tree-shakable per-icon component.
...
const AddCircleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
AddCircleBase.displayName = "AddCircle";

export const AddCircle = memo(AddCircleBase) as typeof AddCircleBase;
