...
/**
 * "replay" icon — tree-shakable per-icon component.
...
const ReplayBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
ReplayBase.displayName = "Replay";

export const Replay = memo(ReplayBase) as typeof ReplayBase;
