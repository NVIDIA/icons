...
/**
 * "chevron-double-up" icon — tree-shakable per-icon component.
...
const ChevronDoubleUpBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "chevron-double-up",
...
ChevronDoubleUpBase.displayName = "ChevronDoubleUp";

export const ChevronDoubleUp = memo(
  ChevronDoubleUpBase,
) as typeof ChevronDoubleUpBase;
