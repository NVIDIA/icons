...
/**
 * "puzzle" icon — tree-shakable per-icon component.
...
const PuzzleBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
PuzzleBase.displayName = "Puzzle";

export const Puzzle = memo(PuzzleBase) as typeof PuzzleBase;
