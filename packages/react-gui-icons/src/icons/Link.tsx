...
/**
 * "link" icon — tree-shakable per-icon component.
...
const LinkBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
export const Link = memo(LinkBase) as typeof LinkBase;
