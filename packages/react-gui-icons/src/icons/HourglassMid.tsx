...
/**
 * "hourglass-mid" icon — tree-shakable per-icon component.
...
const HourglassMidBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HourglassMidBase.displayName = "HourglassMid";

export const HourglassMid = memo(HourglassMidBase) as typeof HourglassMidBase;
HourglassMid.displayName = "HourglassMid";
