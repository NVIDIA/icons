...
/**
 * "wand" icon — tree-shakable per-icon component.
...
const WandBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
WandBase.displayName = "Wand";

export const Wand = memo(WandBase) as typeof WandBase;
