...
/**
 * "transfer-vertical" icon — tree-shakable per-icon component.
...
const TransferVerticalBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "transfer-vertical",
...
TransferVerticalBase.displayName = "TransferVertical";

export const TransferVertical = memo(
  TransferVerticalBase,
) as typeof TransferVerticalBase;
