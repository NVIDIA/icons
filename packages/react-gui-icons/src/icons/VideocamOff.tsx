...
/**
 * "videocam-off" icon — tree-shakable per-icon component.
...
const VideocamOffBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
VideocamOffBase.displayName = "VideocamOff";

export const VideocamOff = memo(VideocamOffBase) as typeof VideocamOffBase;
