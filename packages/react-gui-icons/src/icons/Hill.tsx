...
/**
 * "hill" icon — tree-shakable per-icon component.
...
const HillBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HillBase.displayName = "Hill";

export const Hill = memo(HillBase) as typeof HillBase;
