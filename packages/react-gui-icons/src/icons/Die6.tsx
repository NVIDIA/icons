...
/**
 * "die-6" icon — tree-shakable per-icon component.
...
const Die6Base = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
Die6Base.displayName = "Die6";

export const Die6 = memo(Die6Base) as typeof Die6Base;
Die6.displayName = "Die6";
