...
/**
 * "bell" icon — tree-shakable per-icon component.
...
const BellBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
BellBase.displayName = "Bell";

export const Bell = memo(BellBase) as typeof BellBase;
