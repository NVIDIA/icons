...
/**
 * "generate" icon — tree-shakable per-icon component.
...
const GenerateBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
GenerateBase.displayName = "Generate";

export const Generate = memo(GenerateBase) as typeof GenerateBase;
