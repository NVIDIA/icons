...
/**
 * "hourglass-start" icon — tree-shakable per-icon component.
...
const HourglassStartBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
  ({ variant = "line", size = "1em", title, ...svgProps }, ref) => {
    ...
    return createElement(
      "svg",
      {
        ...
        "data-icon-name": "hourglass-start",
...
HourglassStartBase.displayName = "HourglassStart";

export const HourglassStart = memo(
  HourglassStartBase,
) as typeof HourglassStartBase;
