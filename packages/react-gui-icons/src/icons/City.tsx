...
/**
 * "city" icon — tree-shakable per-icon component.
...
const CityBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
CityBase.displayName = "City";

export const City = memo(CityBase) as typeof CityBase;
