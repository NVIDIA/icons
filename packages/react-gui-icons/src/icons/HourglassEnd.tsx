...
/**
 * "hourglass-end" icon — tree-shakable per-icon component.
...
const HourglassEndBase = forwardRef<SVGSVGElement, NvidiaGuiIconProps>(
...
HourglassEndBase.displayName = "HourglassEnd";

export const HourglassEnd = memo(HourglassEndBase) as typeof HourglassEndBase;
